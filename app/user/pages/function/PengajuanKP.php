...
if ($_GET['aksi'] == "pengajuan") {
    ...
    if (isset($_POST['nama_mahasiswa']) && isset($_POST['judul']) && isset($_POST['link_berkas']) && isset($_POST['kode_dosen'])) {
        ...
        $query = "INSERT INTO pengajuan_kp (id_mahasiswa, kode_dosen, nama_dosen, nama_mahasiswa, judul, link_berkas, status_pengajuan) VALUES ('$id_user', '$kode_dosen', '$nama_dosen', '$nama_mahasiswa', '$judul', '$link_berkas', 0)";
