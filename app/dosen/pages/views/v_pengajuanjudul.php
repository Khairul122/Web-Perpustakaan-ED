                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            $query = mysqli_query($koneksi, "SELECT * FROM pengajuan WHERE kode_dosen = '$kode_dosen'");
                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modalEditData<?php echo $row['id_pengajuan']; ?>"><i class="fa fa-edit"></i></a>
                                            <a href="pages/function/Anggota.php?aksi=hapus&id=<?= $row['id_user']; ?>" class="btn btn-danger btn-sm btn-del"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <!-- Modal Edit Anggota -->
                                    <div class="modal fade" id="modalEditData<?php echo $row['id_pengajuan']; ?>">
                                        <div class="modal-dialog">
                                            <div class="modal-content" style="border-radius: 5px;">
                                                ...
                                                <form action="pages/function/Pengajuan.php?aksi=edit" enctype="multipart/form-data" method="POST">
                                                    <div class="modal-body">
                                                        <input type="hidden" value="<?= $row['id_pengajuan']; ?>" name="id_pengajuan">
